...
angular.module('app.controllers', ['pascalprecht.translate', 'ngCookies'])
  .controller('AppCtrl', ['$scope', '$translate', '$localStorage', '$window', 'loginService', 
    function(              $scope,   $translate,   $localStorage,   $window , loginService) {
      ...
      $scope.app = {
        ...
        settings: {
          ...
          navbarCollapseColor: 'bg-white dk',
          asideColor: 'bg-black',
          headerFixed: true,
          asideFixed: true,
          asideFolded: true,
  ...
  // signup controller
  .controller('SignupFormController', ['$scope', '$http', '$state', 'loginService', function($scope, $http, $state, loginService) {
    $scope.user = {};
    $scope.authError = null;
    $scope.signup = function(data) {
      $scope.authError = null;
      // Try to create
	  loginService.signup(data,$scope,$state);
    };
  }])
 ;