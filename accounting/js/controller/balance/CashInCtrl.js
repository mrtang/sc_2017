...
//Nạp tiền
angular.module('app').controller('CashInCtrl', ['$scope', 'CashIn', 'Config_Status',
 	function($scope, CashIn, Config_Status) {
    // config
        ...
        $scope.setPage = function(){
            ...
            $scope.refresh();
            CashIn.load($scope.currentPage, $scope.frm,'').then(function (result) {
