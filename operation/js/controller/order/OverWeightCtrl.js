...
angular.module('app').controller('OverWeightCtrl', ['$scope', '$rootScope', 'Order', 'Config_Status', 'Base',
 	function($scope, $rootScope, Order, Config_Status, Base) {
        ...
        $scope.frm                  = {group : 102, over_weight: 500, type_process : 5, global: 0};
        ...
        Base.PipeStatus(102, 5).then(function (result) {
