...
angular.module('app').controller('WareHousePackageCtrl', ['$scope', '$filter', 'Config_Status', 'Warehouse',
 	function($scope, $filter, Config_Status, Warehouse) {
        ...
        $scope.frm                  = {type_process : 13, group : 3, domain: 'boxme.vn', location: 4};
        ...
        $scope.exportExcel = function(){
            ...
            var html =
                ...
                "<td style='border-style:none'></td>"+
                "<td colspan='3' style='font-size: 18px; border-style:none '><strong>Danh Sách Đóng Gói Chậm</strong></td></tr>" +
                "<tr></tr>" +
            ...
            Warehouse.package_slow(1,$scope.frm, 'export').then(function (result) {
                if(!result.data.error){
                    ...
                    saveAs(blob, "danh_sach_dong_goi_cham.xls");
                }
            }).finally(function() {
                $scope.waiting_export   = false;
            });
