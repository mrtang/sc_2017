...
angular.module('app').controller('StockingCtrl_', ['$scope', '$rootScope', 'Order', 'Config_Status', 'Base',
 	function($scope, $rootScope, Order, Config_Status, Base) {
        ...
        $scope.frm                  = {group : 25, global: 0, slow: 0, vip : 0,location : 1, to_city : 18, from_city : 18};
        ...
        $scope.exportExcel = function(cmd){
            ...
            if(cmd == 'export_first_accept'){
                window.open( ApiOms + 'inventory/export-customer-by-order-accept?cmd=export&accept_start=' + $scope.frm.accept_start + '&accept_end='+$scope.frm.accept_end, '_blank');
                return;
            }
