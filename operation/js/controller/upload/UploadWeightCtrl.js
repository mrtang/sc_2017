...
angular.module('app').controller('UploadWeightCtrl', ['$scope', '$http', '$state', '$window', '$stateParams', '$rootScope', 'FileUploader', 'toaster', 'Api_Path', 'Upload', 'Config_Status',
    ...
    */
        ...
        var uploader = $scope.uploader = new FileUploader({
            url                 : Api_Path.Upload+'upload?type=weight',
        ...
        uploader.onBeforeUploadItem = function(item) {
            item.url = Api_Path.Upload+'upload?type=weight';
        };
        ...
        uploader.onSuccessItem = function(item, result, status, headers){
            ...
            if(!result.error){
                ...
                $state.go('delivery.upload.upload_weight',{id:result.id});
            }
            else{
     ...
     */
        ...
        $scope.Verify = function(){
            Upload.Weight($stateParams.id).then(function (result) {
        ...
        $scope.exportExcel = function(){
            return Upload.ListUpload($stateParams.id, $scope.currentPage, $scope.frm, 'WEIGHT');
        }
