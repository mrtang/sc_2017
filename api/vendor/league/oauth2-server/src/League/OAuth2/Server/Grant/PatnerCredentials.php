 ...
 */
class PatnerCredentials implements GrantTypeInterface {

    /**
     * Grant identifier
     * @var string
     */
    protected $identifier = 'patner_credentials';
    ...
    public function completeFlow($inputParams = null)
    {
        ...
        $sessionId = $this->authServer->getStorage('session')->createSession($authParams['client_id'], 'patner', $authParams['client_id']);
