...
var css = "";
	...
	css += ".sc_button_weight {background: url('button_weight.png') no-repeat scroll -3px -4px transparent;border: medium none;border-radius: 10px;height: 30px;overflow: hidden;width: 106px;z-index : 99999;}";
	css += ".sc_button_weight:active {background: url('button_weight.png') no-repeat scroll -3px -40px transparent;}";
	css += "#sc_button_submit_weight{background: url('button_weight.png') no-repeat scroll -256px -4px transparent;border: medium none;height: 24px;left: 100px;overflow: hidden;position: absolute;top: 30px;width: 35px;}";
	css += "#sc_button_submit_weight:active{background: url('button_weight.png') no-repeat scroll -256px -33px transparent;}";
	css += ".sc_popup_weight{background: url('button_weight.png') no-repeat scroll -115px -2px transparent;height: 73px;left: -20px;position: absolute;top: -75px;width: 137px;z-index: 9999;";
	lj.type = "text/css";
	if (lj.styleSheet) {
