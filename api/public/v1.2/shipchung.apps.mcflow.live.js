...
{  
    if((sc_free_protected && sc_free_protected != 'undefined') || (sc_free_cod && sc_free_cod != 'undefined' && sc_free_cod == 'yes') || (sc_free_shipping && sc_free_shipping != 'undefined'))
    {
          ...
          else if(sc_button_nl_level == 'sliver'){
          ...
          var SC_html_content       = 
            ...
            +   '   <a shipchung_ajjax = "' + SC_AJAX + '" shipchung_type="'+ sc_button_type.toLowerCase() +'" shipchung_method="'+ sc_button_method.toLowerCase() +'" class="shipchung_' + sc_button_cod + '_button" href="javascript:();" cod="' + ((sc_button_cod_option) ? sc_button_cod_option.toLowerCase() : '') + '" rel="' + sc_button_id + '" id="sc_event_click_button"></a>'
...
{
    var SC_html_content       = '<a shipchung_ajjax = "' + SC_AJAX + '" shipchung_type="'+ sc_button_type.toLowerCase() +'" shipchung_method="'+ sc_button_method.toLowerCase() +'" class="shipchung_pas_button" href="javascript:();" cod="" rel="' + sc_button_id + '" id="sc_event_click_button"></a><br/>';
}
else if(sc_button_type == 'payment' && sc_button_cod == 'cod') // Gio hang COD
{
    var SC_html_content       = '<a shipchung_ajjax = "' + SC_AJAX + '" shipchung_type="'+ sc_button_type.toLowerCase() +'" shipchung_method="'+ sc_button_method.toLowerCase() +'" class="shipchung_cod_button" href="javascript:();" cod="' + ((sc_button_cod_option) ? sc_button_cod_option.toLowerCase() : '') + '" rel="' + sc_button_id + '" id="sc_event_click_button">Giao hàng & Thu tiền</a><br/>';
}  
...
jQuery('a#sc_event_click_button').live('click',function(e){
	e.stopPropagation();
    ...
    if((jQuery(this).attr('shipchung_type') =='detail' || jQuery(this).attr('shipchung_type') =='payment') && jQuery(this).attr('shipchung_method') =='ajax') 
    {
      ...
      var shipchung_ajjax = jQuery(this).attr('shipchung_ajjax');
      if(Ajax && !window.MooTools) { 
        if(jQuery.isFunction(Ajax.Request))
        {
            new Ajax.Request(shipchung_ajjax,{
                        method: 'post',
                        parameters: {"id":jQuery(this).attr("rel"),"quantity":quantity},
        ...
        {
            Ajax.call(shipchung_ajjax, 'id=' + jQuery(this).attr("rel") + '&quantity=' + quantity, json_result, "POST", "TEXT");
        }
      }
      else {
        jQuery.ajax({
