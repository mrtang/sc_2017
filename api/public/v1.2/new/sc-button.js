...
(function (exports){
	...
	var ShipChung = function (){
		...
		this._assetApi 			= 'http://services.shipchung.vn/public/sdk/'; //http://services.shipchung.vn/public/sdk/  - http://10.0.1.199/ussdtest/popup-lib/
	...
	ShipChung.prototype.parseElements = function (){
		...
		for(var i = 0; i < eles.length; i ++){
			...
			var buttonHTML = "<button class='sc-button btn-size-" + elSize + " btn-style-" + elStyle + "'>" + buttonText + "</button>";
	...
	ShipChung.prototype.parseElementV1 = function (){
		...
		document.getElementById('sc_event_click_button').addEventListener('click', function (){
		    ...
		    var quantity = (document.getElementById(SC_QUANTITY)) ? parseInt(document.getElementById(SC_QUANTITY).value) : ((parseInt(document.getElementsByName(SC_QUANTITY)[0].value) > 0) ? parseInt(document.getElementsByName(SC_QUANTITY)[0].value) : 1);
	...
	ShipChung.prototype.getItemsFromButton = function (buttonEl){
	...
	ShipChung.prototype.fireEvent  = function (el, ev, callback){
		...
		el.addEventListener(ev, function (){
			...
			var Items = me.getItemsFromButton(el);
			if(Items){
