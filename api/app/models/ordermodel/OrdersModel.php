...
class OrdersModel extends Eloquent {
    ...
    public function OrderTracking(){
        return $this->hasOne('ordermodel\OrderTrackingModel','order_id');
    }
    ...
    public function OrderItems(){
        return $this->hasMany('ordermodel\OrderItemModel','order_id');
    }
    ...
    public function ToCountry(){
        return $this->belongsTo('CountryModel','to_country_id');
    }
    ...
    public function __post_office(){
        return $this->hasOne('ordermodel\PostOfficeModel','order_id')->select(['id','order_id','from_postoffice_code','to_postoffice_code']);
    }
    ...
    public function _get_package(){
        return $this->belongsTo('\warehousemodel\PackageModel', 'tracking_code', 'tracking_code')->select(['id', 'warehouse','tracking_code','size','create']);
    }
