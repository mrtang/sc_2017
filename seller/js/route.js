                        ...
                        function($ocLazyLoad, $q) {
                            ...
                            angular.forEach(srcs, function(src) {
                                promise = promise.then(function() {
                                    // if (JQ_CONFIG[src]) {
                                    //     return $ocLazyLoad.load(JQ_CONFIG[src], {cache: false});
                                    // }
        ...
        $stateProvider
            ...
            **/
            ...
            .state('app.config.key', {
                ...
                resolve: load('js/controller/config/ApiKeyCtrl.js')
            })
            /**
             * Ticket
             **/
            ...
            .state('order.upload3', {
                ...
                resolve: load(['xeditable', 'js/controller/order/CreateExcelCtrl.js?v='+Math.random()+''])
            })
            .state('order.upload', {
                url: '/upload?id',
            ...
            .state('order.create_once_global', {
                ...
                templateUrl: 'tpl/create/one_global.html',
            ...
            .state('order.create_once_global_bm', {
                ...
                templateUrl: 'tpl/create/one_global_bm.html',
                resolve: load(['angular-bootbox','js/controller/create/CreateOrderGlobal.js?v='+Math.random()+''])
            })
            ...
            // TAO SAN PHAM ['xeditable','angular-bootbox']
            .state('product.add', {
					url: '/product/add',
					templateUrl: 'tpl/product/add.html',
		            resolve: load(['js/controller/product/Service_Product.js', 'js/controller/product/Product_Add_Product_Controller.js'])
				})
			//EDIT SAN PHAM
			.state('product.edit', {
					url: '/product/edit/:code',
					templateUrl: 'tpl/product/add.html',
					resolve: load(['js/controller/product/Service_Product.js', 'js/controller/product/Product_Add_Product_Controller.js'])
				})
				// TAO SAN PHAM EXCEL
			...
			.state('product.shipment-create', {
                ...
                .state('product.shipment-edit-v2', {
	                ...
	                .state('invoice-mau', {
						url: '/invoice',
						templateUrl: 'tpl/orders/invoice_mau.html',
						resolve: load(['xeditable', 'js/controller/order/InvoiceController.js'])
					})
					//TRANG PRINT KERRY
		            .state('print_kerry', { 
